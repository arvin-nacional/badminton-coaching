...
const defaultIllustrations: Record<string, string> = {
  ...
  'High Serve and First Recovery': '/images/drills/singles-high-serve-base-recovery.svg',
  ...
  'Doubles Serve and Return Start': '/images/drills/doubles-serve-return-start.svg',
  'Lift for Length': '/images/drills/lift-for-length.png',
  'Progressive Rally Ladder': '/images/drills/twenty-shot-cooperative-rally.png',
