    ...
    <header className="border-b border-[#092c59]/10 bg-white px-5 md:px-8">
      <div className="mx-auto flex h-[72px] max-w-[1440px] items-center justify-between gap-3">
        ...
        >
          <span
            aria-hidden="true"
            className="h-9 w-20 animate-pulse rounded-full bg-[#e2ebf5] motion-reduce:animate-none sm:w-24"
          />
          <span
            aria-hidden="true"
            className="h-10 w-28 animate-pulse rounded-full bg-[#c9d8e8] motion-reduce:animate-none sm:w-32"
          />
        </div>
      </div>
    </header>
