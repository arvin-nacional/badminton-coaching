...
Changes made in `./src` will be reflected in your app. Create the first administrator using the trusted terminal command described in [Administrator setup](docs/admin-setup.md); web administrator registration is disabled. Then check out [Production](#production) once you're ready to build and serve your app, and [Deployment](#deployment) when you're ready to go live.
